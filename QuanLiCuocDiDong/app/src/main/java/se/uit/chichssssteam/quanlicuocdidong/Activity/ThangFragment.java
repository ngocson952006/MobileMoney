...
public class ThangFragment extends Fragment {
     ...
     * @return A new instance of fragment ThangFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ThangFragment newInstance(String param1, String param2) {
        ThangFragment fragment = new ThangFragment();
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onThangFragmentInteraction(uri);
        }
    }
